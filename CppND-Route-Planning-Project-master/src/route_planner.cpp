...
{
    // sort open list using Compare, remove node with the lowest g+h value and then return that node
...
void RoutePlanner::AStarSearch() {
  ...
  // TODO: Implement your solution here.
    ...
    start_node->visited=true; //initialise open list with start node
